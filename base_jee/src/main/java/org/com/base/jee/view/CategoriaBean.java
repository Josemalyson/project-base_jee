...
public class CategoriaBean implements Serializable {
	...
	@PersistenceContext(unitName = "base_jee-persistence-unit", type = PersistenceContextType.EXTENDED)
	...
	public String update() {
		...
		try {
			if (this.id == null) {
				...
				return "view?faces-redirect=true&id=" + this.categoria.getId();
			}
		} catch (Exception e) {
	...
	public Converter getConverter() {
		...
		final CategoriaBean ejbProxy = this.sessionContext
				.getBusinessObject(CategoriaBean.class);
